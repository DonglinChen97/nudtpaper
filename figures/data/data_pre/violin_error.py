...
def df():
    with open('./model1_error.txt') as f: 
        lines = f.readlines()
    with open('./model2_error.txt') as f1: 
        lines1 = f1.readlines()
    with open('./model3_error.txt') as f2: 
        lines2 = f2.readlines()
    with open('./model4_error.txt') as f3: 
        lines3 = f3.readlines()
    with open('./model5_error.txt') as f4: 
        lines4 = f4.readlines()
...
if __name__ == '__main__':
    ...
    plt.ylim(0,0.7)
    plt.ylabel(r"$\rm{Error}_s$" + "%",size=18)
    plt.xlabel('')
